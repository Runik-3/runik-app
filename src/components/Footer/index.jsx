...
const Footer = () => {
    return (
        <div className=" -z-20 w-full flex justify-between p-3 bg-runik-neutral-light border-runik-neutral-gray border-t text-lg font-normal text-runik-neutral-med">
