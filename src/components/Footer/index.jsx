...
const Footer = () => {
    return (
        <div className="flex flex-col sm:flex-row justify-between w-full p-3 bg-runik-neutral-light border-runik-neutral-gray border-t text-sm sm:text-lg font-normal text-runik-neutral-med">
