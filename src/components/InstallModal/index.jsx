...
export default function InstallModal({
    ...
    return (
        <div className="flex justify-center items-center absolute top-0 left-0 bg-black h-screen w-screen bg-opacity-40">
            <div className="z-50 flex flex-col absolute w-3/6 h-72 bg-white rounded-xl p-6">
                <button
                    type="button"
